...
function Start(){
	...
	Debug.Log("Tree Collider being destroyed! OMG RUN AWAY! " + (pgobTreeCollide!=null).ToString());
	Destroy(this);
	}
}
...
function Update () 
{
	...
	var vecFlier : Vector3 = GameObject.FindGameObjectWithTag("Player").transform.position;        // My protagonist's position, passed by a static variable in a script called sctFly.
